...
<Project Type="Project" LVVersion="20008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Package Dependencies" Type="IIO Ladder Diagram">
			...
			<Item Name="jki_lib_smo_dictionary [new requirement found]" Type="{2DC17C6E-B9FF-4CBE-BC4B-3D45FE0534D9}"/>
			<Item Name="jki_lib_state_machine [new requirement found]" Type="{2DC17C6E-B9FF-4CBE-BC4B-3D45FE0534D9}"/>
			<Item Name="jki_statemachineobjects [new requirement found]" Type="{2DC17C6E-B9FF-4CBE-BC4B-3D45FE0534D9}"/>
			<Item Name="oglib_file [new requirement found]" Type="{2DC17C6E-B9FF-4CBE-BC4B-3D45FE0534D9}"/>
			<Item Name="oglib_time [new requirement found]" Type="{2DC17C6E-B9FF-4CBE-BC4B-3D45FE0534D9}"/>
			<Item Name="oglib_variantconfig [new requirement found]" Type="{2DC17C6E-B9FF-4CBE-BC4B-3D45FE0534D9}"/>
		</Item>
